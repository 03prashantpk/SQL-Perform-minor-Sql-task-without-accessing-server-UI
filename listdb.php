...
if (isset($_POST["submit"])) {
    ...
    $pdo = new PDO("mysql:host=$server_name;", $server_user_name, $server_password);
...
<body>
    ...
    <?php if (isset($_POST["submit"])) {
        echo '
            ...
            <br><br> <br><br>
            <div class="centerd2">
                <div class="input-group flex-nowrap newdata">
        ...
        <div class="centerd">
            <div class="input-group flex-nowrap">
                <form class="form" action="" method="POST">
                    ...
                    <input type="submit" name="submit" value="List Databases">
                    <br><br>
                </form>
            </div>
        </div>
